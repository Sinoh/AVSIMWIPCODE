...
main (int argc, char *argv[])
{
  ...
  // AirSimClient->SetAttribute ("SumoConfigPath", StringValue ("src/traci/examples/circle-simple/circle.sumo.cfg"));
  // AirSimClient->SetAttribute ("SumoBinaryPath", StringValue (""));    // use system installation of sumo
  ...
  // AirSimClient->SetAttribute ("SumoSeed", IntegerValue (10));
  // AirSimClient->SetAttribute ("SumoAdditionalCmdOptions", StringValue ("--verbose true"));
  AirSimClient->SetAttribute ("SumoWaitForSocket", TimeValue (Seconds (10.0)));
