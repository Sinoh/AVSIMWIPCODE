...
void
TraCIAPI::check_testResultState(tcpip::Storage& inMsg, int command, bool ignoreCommandId, std::string* acknowledgement) const {
...
void
TraCIAPI::testReadInPackage(tcpip::Storage& inMsg, libsumo::SubscriptionResults& into, int bytesReceived) {
  std::cout << "in readInPackage with inMsge: ";
  std::cout << inMsg.readString();
